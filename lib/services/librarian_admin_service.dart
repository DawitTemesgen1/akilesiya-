...
class LibrarianAdminService {
  static Future<Map<String, dynamic>> _handleRequest(
    ...
    try {
      ...
      // Add a log for the raw response body here, similar to what was intended for ProfileService
      developer.log(
          "--- LIBRARIAN ADMIN SERVICE RAW RESPONSE ---\n${response.body}\n--------------------",
          name: 'LibrarianAdminService');
      ...
      developer.log(
          "Failed to decode JSON. Server likely sent HTML. Full error: $e",
          name: 'LibrarianAdminService',
          error: e);
      return {
        'success': false,
