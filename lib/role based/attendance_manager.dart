              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                        _selectedDate
                            .toString(), // Ethiopian date uses Amharic month names
                        style: GoogleFonts.notoSansEthiopic(
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
                            color: onSurfaceColor)),
                    Text(
                        DateFormat.yMMMEd().format(_selectedDate.toGregorian()),
                        style: GoogleFonts.poppins(
                            // Keep Poppins for Gregorian date
                            fontSize: 14,
