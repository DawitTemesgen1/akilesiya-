...
// import 'package:amde_haymanot_abalat_guday/role%20based/attendance_manager.dart'; // This import seems unused, but left as per your code.
...
class _PlanControlScreenState extends State<PlanControlScreen>
  ...
  void initState() {
    ...
    final isSuperiorAdmin =
        userProvider.userProfile?['role'] == 'superior_admin';

    _tabController =
        TabController(length: isSuperiorAdmin ? 3 : 2, vsync: this);
  ...
  Widget build(BuildContext context) {
    ...
    final userRole = userProvider.userProfile?['role'];
    final bool isSuperiorAdmin = userRole == 'superior_admin';
    ...
    return Scaffold(
      ...
      floatingActionButton: _buildFloatingActionButton(isSuperiorAdmin),
    );
  }
    ...
    return AppBar(
      ...
      bottom: TabBar(
        ...
        tabs: [
          ...
          if (isSuperiorAdmin)
            // ======================= FIX 3 =======================
            // Corrected the icon name to a valid Material Icon.
            const Tab(
    ...
    return Dismissible(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
            side:
                BorderSide(color: department.color.withOpacity(0.5), width: 1)),
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          onTap:
  ...
  InputDecoration _getDialogInputDecoration(String label) {
    return InputDecoration(
      labelText: label,
      labelStyle:
          GoogleFonts.notoSansEthiopic(color: Colors.white.withOpacity(0.7)),
