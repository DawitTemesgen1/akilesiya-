...
class SyncStatusIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (syncProvider.isOnline && syncProvider.pendingCount == 0 && !syncProvider.isSyncing) {
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: isAmharic
                  ? GoogleFonts.notoSansEthiopic(color: Colors.white, fontSize: 12)
    ...
    if (!syncProvider.isOnline) {
      return Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Iconsax.wifi_square, color: Colors.white, size: 16),
            const SizedBox(width: 8),
            Text(
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(Iconsax.cloud_add, color: Colors.white, size: 16),
              const SizedBox(width: 8),
              Text(
                isAmharic
                    ? '${syncProvider.pendingCount} በመጠባበቅ ላይ'
