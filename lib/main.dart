...
Future<void> main() async {
  ...
  try {
    ...
    developer.log('----------------------------------------------------',
        name: 'Main');
    developer.log('🔌 API URL Configured: $apiBaseUrl', name: 'Main');
    developer.log('----------------------------------------------------',
        name: 'Main');
    ...
    developer.log('✅ Application Initialized Successfully', name: 'Main');
  } catch (e, stackTrace) {
    ...
    return ThemeData(
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: isDark ? Colors.black87 : primaryColor,
        ...
        cardTheme: CardThemeData(
          ...
          shadowColor: Colors.black.withValues(alpha: isDark ? 0.7 : 0.1),
