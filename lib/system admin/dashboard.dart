    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)?.sysAdminRecentActivity ??
                  'Recent Activity',
              style: GoogleFonts.notoSansEthiopic(
                fontSize: 18,
                fontWeight: FontWeight.bold,
              ...
              return ListTile(
                ...
                title: Text(
                  activity['school_name'] ??
                      (AppLocalizations.of(context)?.sysAdminUnknownSchool ??
                          'Unknown School'),
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppLocalizations.of(context)?.sysAdminOverviewSubtitle ??
                  ...
                  Text(
                    AppLocalizations.of(context)?.sysAdminQuickActions ??
                        'Quick Actions',
                    style: GoogleFonts.notoSansEthiopic(
                      fontSize: 22,
                      fontWeight: FontWeight.bold,
                  ...
                  const SizedBox(height: 8),
                  Text(
                    AppLocalizations.of(context)?.sysAdminToolsLabel ??
                        'System Admin Tools',
                    style: GoogleFonts.notoSansEthiopic(
                      color: Colors.grey,
                      fontSize: 14,
                  ...
                  Column(
                    children: [
                      _buildActionCard(
                        AppLocalizations.of(context)?.drawerSchoolsManagement ??
                            'Schools Management',
                      ...
                      const SizedBox(height: 12),
                      _buildActionCard(
                        AppLocalizations.of(context)?.drawerUserManagement ??
                            'User Management',
                      ...
                      const SizedBox(height: 12),
                      _buildActionCard(
                        AppLocalizations.of(context)?.drawerPlatformAnalytics ??
                            'Platform Analytics',
                      ...
                      const SizedBox(height: 12),
                      _buildActionCard(
                        AppLocalizations.of(context)?.drawerAuditReport ??
                            'Audit Report',
                      ...
                      const SizedBox(height: 12),
                      _buildActionCard(
                        AppLocalizations.of(context)?.drawerSystemSettings ??
                            'System Settings',
